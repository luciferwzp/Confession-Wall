...
class SendEmail
{
    ...
    private static $From = '1114183435@qq.com'; //发送者的邮件地址
    private static $FromName = 'LoveWall'; //发送邮件的用户昵称
    private static $Username = '1114183435@qq.com'; //登录到邮箱的用户名
    private static $Password = 'f...199771'; //第三方登录的授权码，在邮箱里面设置
    /**
     * @desc 发送普通邮件
     * @param $title 邮件标题
     * @param $message 邮件正文
