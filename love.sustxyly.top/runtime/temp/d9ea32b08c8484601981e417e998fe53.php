<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"/www/wwwroot/love.sustxyly.top/public/../application/admin/view/index/system_setting.html";i:1562324464;}*/ ?>
<!--
 * @Description: 
 * @version: 2.0
 * @Author: 小橙子
            ...
            <div class="layui-row layui-col-space15">
              <div class="layui-col-md12">
                ...
                <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input value="<?php echo $data['keywords']; ?>" type="text" name="keywords" required  lay-verify="required" placeholder="网站Seo相关-关键词" autocomplete="off" class="layui-input">
                        </div>
                        </div>
                        <div class="layui-form-item">
                        <label class="layui-form-label">网站描述</label>
                        <div class="layui-input-block">
                            <input value="<?php echo $data['description']; ?>" type="text" name="description" required  lay-verify="required" placeholder="网站Seo相关-描述" autocomplete="off" class="layui-input">
                        </div>
                        </div>
                      ...
                      <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                          <input value="<?php echo $data['icp']; ?>" type="text" name="icp" required  lay-verify="required" placeholder="备案ICP" autocomplete="off" class="layui-input">
                        </div>
                      </div>
                      <div class="layui-form-item">
                        ...
                        <label class="layui-form-label">统计Code</label>
                        <div class="layui-input-block">
                            <textarea name="cnzz" placeholder="请输入内容,支持HTML" class="layui-textarea"><?php echo $data['cnzz']; ?></textarea>
                        </div>
                        </div>
                        <div class="layui-form-item layui-form-text">
