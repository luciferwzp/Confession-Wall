<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"W:\lovewall\public/../application/admin\view\index\school_add.html";i:1558152809;}*/ ?>
<!DOCTYPE html>
        ...
        <script>
                layui.use('upload', function(){
                  ...
                  var uploadInst = upload.render({
                    elem: '#test1' //绑定元素
                    ,url: "<?php echo url('index/index/upload'); ?>" //上传接口
                    ...
                    ,done: function(res){
                      //上传完毕回调
                      layer.closeAll();
                      $('input[name=web_logo]').val(res.data.src);
                    }
                    ,error: function(){
                      //请求异常回调
                    }
