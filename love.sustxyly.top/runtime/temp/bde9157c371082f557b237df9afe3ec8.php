<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/wwwroot/love.sustxyly.top/public/../application/index/view/index/serachInfo.html";i:1562326408;s:68:"/www/wwwroot/love.sustxyly.top/application/index/view/comm/head.html";i:1571727119;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <div class="layui-card">
      ...
      <div class="layui-card-body">
        ...
        <form class="layui-form" action="">
          ...
          <div class="layui-form-item">
            <div class="layui-input-block">
              <button class="layui-btn" lay-submit lay-filter="subSerach">立即提交</button>
