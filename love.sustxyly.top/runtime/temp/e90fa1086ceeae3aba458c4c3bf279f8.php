<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:63:"W:\lovewall\public/../application/admin\view\index\welcome.html";i:1558237493;}*/ ?>
<!--
 * @Description: 
 * @version: 2.0
 * @Author: 小橙子
                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            ...
                            <blockquote class="layui-elem-quote">
                                <span class="x-red">温馨提示：</span>首次使用请配置发信邮箱 Application\extend\PHPMailer\SendEmail.php
                            </blockquote>
                            <blockquote class="layui-elem-quote">
                                <span class="x-red">温馨提示：</span>当前版本Lw2.0.190519,持续更新,遇到bug或有什么建议可<a href="https://pro.kres.cn/form/index/bugSubmit"><span class="x-red">点此提交</span></a>
                            </blockquote>
                            <blockquote class="layui-elem-quote">
