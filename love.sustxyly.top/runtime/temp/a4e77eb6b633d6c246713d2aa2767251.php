<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/www/wwwroot/love.sustxyly.top/public/../application/index/view/school/real.html";i:1562326362;s:68:"/www/wwwroot/love.sustxyly.top/application/index/view/comm/head.html";i:1571727119;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
	...
	<div class="menu">
		<div class="container">
			<nav>
                ...
                <a href="/index/school/realpage/zid/<?php echo $data['zid']; ?>" class="active">实名</a>
...
<div id="content">
	<div class="container">
		<div class="list-item">
            ...
            <div class="<?php switch($vo['sex']): case "1": ?>item boy<?php break; case "0": ?>item girl<?php break; default: ?>item<?php endswitch; ?>">
				<article>
               		<?php echo $vo['text']; ?>
				</article>
				<div class="author">
					<?php switch($vo['mous']): case "0": ?><img class="avatars avatar" id="<?php echo $vo['qq']; ?>" src="//q1.qlogo.cn/g?b=qq&amp;nk=<?php echo $vo['qq']; ?>&amp;s=100"><?php break; default: ?><img class="avatar" src="/static/img/mous.jpg">
					<?php endswitch; ?>
					<p class="name">
