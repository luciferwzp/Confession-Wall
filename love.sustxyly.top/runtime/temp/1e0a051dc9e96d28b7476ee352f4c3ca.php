<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"W:\lovewall\public/../application/admin\view\comm\login.html";i:1557988290;}*/ ?>
<!doctype html>
<html  class="x-admin-sm">
<head>
	<meta charset="UTF-8">
	<title>后台登录-Kres LW2.0</title>
                    ...
                    ,success:function(data){
                        if(data.code==0){
                            ...
                            layer.msg(data.msg,{icon:2},function(index){
                                location.href="<?php echo url('comm/login_em'); ?>"
                            })    
                        }
                        else{
