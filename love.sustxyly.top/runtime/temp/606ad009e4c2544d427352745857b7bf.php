<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/www/wwwroot/love.sustxyly.top/public/../application/index/view/school/comment.html";i:1562326300;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>
  <?php switch($postdata['mous']): case "1": ?>一位不署名发帖 - <?php echo $data['web']['web_name']; break; default: ?><?php echo $postdata['name']; ?> 的帖子 - <?php echo $data['web']['web_name']; endswitch; ?>
...
<div id="header">
	...
	<div class="menu">
		<div class="container">
			<nav>
				<a href="/index/school/indexpage/zid/<?php echo $data['web']['zid']; ?>" class="">首页</a>
                <a href="/index/school/realpage/zid/<?php echo $data['web']['zid']; ?>" >实名</a>
                <a href="/index/school/mouspage/zid/<?php echo $data['web']['zid']; ?>" class="">匿名</a>
                <a href="/index/school/callpage/zid/<?php echo $data['web']['zid']; ?>" class="">表白</a>
			</nav>
		</div>
	</div>
</div>
...
<div >
            ...
            <div class="cont-body">
                ...
                <div id="share" style="margin: 5px;"></div>
                <br/>
                <div class="index-comm-send">
                    <label style="float:left;color: white;">发情区</label>
                    <br />
            ...
            <div class="comment">
				<table class="comment-table">
                    ...
                    <?php else: ?>
                        <tbody><tr>
                                <?php if(is_array($commentlist['list']) || $commentlist['list'] instanceof \think\Collection || $commentlist['list'] instanceof \think\Paginator): $i = 0; $__LIST__ = $commentlist['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$comm_data): $mod = ($i % 2 );++$i;?>
	...
	<div class="copyright container">
		&copy; 2019 
		<a href="/"><?php echo $data['web']['web_name']; ?></a>&nbsp;&nbsp;
